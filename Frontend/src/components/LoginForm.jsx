...
import { login as loginSuccess } from '../store/slice/authSlice';
import { useNavigate } from '@tanstack/react-router';
...
const LoginForm = ({ state }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.user) {
        dispatch(loginSuccess(response.user)); // ✅ store user in Redux
      ...
      <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            ...
            <span onClick={() => state(false)} className="text-blue-500 hover:text-blue-700 cursor-pointer">
              Register
            </span>
          </p>
        </div>
